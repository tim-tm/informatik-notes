...
\begin{flushleft}
    ...
    \textattachfile[color=0 0 0]{code/Queue.java}{\textit{Abiturvorgabe: Queue}}
\end{flushleft}
...
\begin{flushleft}
    ...
    \begin{lstlisting}
        ...
        queue.dequeue();
    \end{lstlisting}
    \textattachfile[color=0 0 0]{code/Queue_Beispiel1.java}{\textit{Unkommentierter Code}} \\
    ...
    \begin{lstlisting}
        ...
        queue.dequeue();
    \end{lstlisting}
    \textattachfile[color=0 0 0]{code/Queue_Beispiel2.java}{\textit{Unkommentierter Code}} \\
    ...
    \end{lstlisting}
    \textattachfile[color=0 0 0]{code/Queue_Beispiel3.java}{\textit{Unkommentierter Code}} \\
    ...
    \end{lstlisting}
    \textattachfile[color=0 0 0]{code/Queue_Beispiel4.java}{\textit{Unkommentierter Code}}
\end{flushleft}
